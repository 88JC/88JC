    ...
    switch (statusValue) {
      case 'online':
        return (
          <div className="relative group">
            <div className="w-4 h-4 rounded-full bg-[#3ba55c] transition-all duration-300 ease-in-out hover:scale-110 animate-pulse-slow shadow-md shadow-[#3ba55c]/30" aria-label="online"></div>
      ...
      case 'streaming':
        return (
          <div className="relative group">
            <div className="relative w-4 h-4 transition-all duration-300 ease-in-out hover:scale-110">
              <div className="absolute w-4 h-4 rounded-full bg-[#5865f2] animate-pulse-gentle shadow-md shadow-[#5865f2]/30" aria-label="streaming"></div>
  ...
  return (
    <div className="inline-flex items-center gap-3 min-w-[60px] min-h-[28px] transition-opacity duration-300">
      ...
      {status.custom_status && (
        <span className="text-lg opacity-70 transition-opacity duration-300 hover:opacity-100">- {status.custom_status}</span>
      )}
    </div>
  );
} 